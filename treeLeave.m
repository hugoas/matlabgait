...
% Set up Leave one out validation
cvp = cvpartition(response, 'LeaveOut');
trainingPredictors = predictors(cvp.training,:);
trainingResponse = response(cvp.training,:);

% Train a classifier
validationModel = fitctree(trainingPredictors, trainingResponse, 'PredictorNames', {'column_2' 'column_3' 'column_4' 'column_5' 'column_6' 'column_7' 'column_8' 'column_9' 'column_10' 'column_11'}, 'ResponseName', 'column_1', 'ClassNames', [0 1], 'SplitCriterion', 'gdi', 'MaxNumSplits', 4, 'Surrogate', 'off');
