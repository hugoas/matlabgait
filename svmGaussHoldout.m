...
% Train a classifier
trainedClassifier = fitcsvm(predictors, response, 'KernelFunction', 'gaussian', 'PolynomialOrder', [], 'KernelScale', 7.900000e-01, 'BoxConstraint', 1, 'Standardize', 1, 'PredictorNames', {'column_2' 'column_3' 'column_4' 'column_5' 'column_6' 'column_7' 'column_8' 'column_9' 'column_10' 'column_11'}, 'ResponseName', 'column_1', 'ClassNames', [0 1]);
...
% Train a classifier
validationModel = fitcsvm(trainingPredictors, trainingResponse, 'KernelFunction', 'gaussian', 'PolynomialOrder', [], 'KernelScale', 7.900000e-01, 'BoxConstraint', 1, 'Standardize', 1, 'PredictorNames', {'column_2' 'column_3' 'column_4' 'column_5' 'column_6' 'column_7' 'column_8' 'column_9' 'column_10' 'column_11'}, 'ResponseName', 'column_1', 'ClassNames', [0 1]);
